...
float4 centerOfMassGPU(const Particles &p,
    ...
    float com_w = 0.0f;
#pragma acc parallel loop seq present(p) reduction(+:weighted_sum_pos_x, weighted_sum_pos_y, weighted_sum_pos_z, com_w) num_gangs(1) num_workers(1) vector_length(1)
