...
#pragma acc parallel loop  present(p, tmp_vel) tile(32,32)
...
#pragma acc loop
        for (unsigned p2_index = 0; p2_index < N; p2_index++) {
            ...
            unsigned index = p1_index * N + p2_index;
            ...
            tmp_vel.vel_x[index] = not_colliding ? Fg_dt_m2_r * dx : 0.0f;
            tmp_vel.vel_y[index] = not_colliding ? Fg_dt_m2_r * dy : 0.0f;
            tmp_vel.vel_z[index] = not_colliding ? Fg_dt_m2_r * dz : 0.0f;
        }
    }
